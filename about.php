...
<?php include("./globals/header.php")?>
    ...
    <div class="drivco-gallery mb-20">
      <div class="container">
        ...
        <div class="row g-4 mb-50">
          ...
          >
            <div class="gallery-item">
              ...
              />
              <a
                href="assets/img/inner-page/gallery-01.png"
          ...
          <div
            class="col-lg-4 col-sm-6 d-flex align-items-end wow fadeInUp"
          ...
          >
            <div class="gallery-item">
              ...
              />
              <a
                href="assets/img/inner-page/gallery-02.png"
                data-fancybox="gallery"
                class="gallary-item-overlay"
              ></a>
            </div>
          ...
          >
            <div class="gallery-item">
              ...
              />
              <a
                href="assets/img/inner-page/gallery-03.png"
                data-fancybox="gallery"
                class="gallary-item-overlay"
              ></a>
            </div>
          ...
          >
            <div class="gallery-item">
              ...
              />
              <a
                href="assets/img/inner-page/gallery-04.png"
                data-fancybox="gallery"
                class="gallary-item-overlay"
              ></a>
            </div>
          ...
          <div
            class="col-lg-4 col-sm-6 d-flex align-items-start wow fadeInUp"
          ...
          >
            <div class="gallery-item">
              ...
              />
              <a
                href="assets/img/inner-page/gallery-05.png"
                data-fancybox="gallery"
                class="gallary-item-overlay"
              ></a>
            </div>
          ...
          >
            <div class="gallery-item">
              ...
              />
              <a
                href="assets/img/inner-page/gallery-06.png"
                data-fancybox="gallery"
                class="gallary-item-overlay"
              ></a>
            </div>
        ...
        <div class="row wow fadeInUp" data-wow-delay="200ms">
          <div class="col-lg-12 d-flex justify-content-center">
            <div class="view-more-btn">
              <a class="primary-btn3" href="#">View More</a>
            </div>
          </div>
        </div>
      </div>
